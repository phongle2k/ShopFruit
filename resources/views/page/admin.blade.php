...
<head>
  ...
  <base href="{{ asset('') }}
  <!-- Font Awesome -->
  <link rel="stylesheet" href="source/assets/dest/css/all.min.css">
  <!-- Ionicons -->
  <link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
  <!-- Tempusdominus Bbootstrap 4 -->
  <link rel="stylesheet" href="source/assets/dest/css/tempusdominus-bootstrap-4.min.css">
  <!-- iCheck -->
  <link rel="stylesheet" href="source/assets/dest/css/icheck-bootstrap.min.css">
  <!-- JQVMap -->
              ...
              <div class="card-body">
                ...
                <div class="direct-chat-contacts">
                  <ul class="contacts-list">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="plugin/dist/img/user5-128x128.jpg">
