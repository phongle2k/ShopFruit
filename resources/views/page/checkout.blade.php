                    ...
                    <div class="your-order">
                        ...
                        <div class="your-order-body" style="padding: 0px 10px">
                            <div class="your-order-item">
                                ...
                                <!--  one item	-->
                                    <div class="media">
                                        <img width="25%" src="source/image/product/{{$hang['item']['image']}}" alt="" class="pull-left">
                                        <div class="media-body">
                                            <p class="font-large">{{$hang['item']['name']}}</p>
                                            <span class="color-gray your-order-info">{{number_format($hang['price'])}}Đồng</span>
                                            <span class="color-gray your-order-info">{{$hang['qty']}}</span>
                                        </div>
                                    </div>
                                <!-- end one item -->
                                <@endforeach
